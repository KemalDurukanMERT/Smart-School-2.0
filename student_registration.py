...
class RegisterApp(QDialog):
    ...
    def register(self):
        ...
        try:
            ...
            '''
            cur.execute(command, (email, password, name, surname, phone, city, 'student', 'Active'))

            cur.close()

            self.conn.commit()

            QMessageBox.information(self, "Registration Successful", "Your student account created successfully")
